...
// forget_dsc
NumericVector forget_dsc(NumericVector weights, double gam);
RcppExport SEXP _hdflex_forget_dsc(SEXP weightsSEXP, SEXP gamSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< double >::type gam(gamSEXP);
    rcpp_result_gen = Rcpp::wrap(forget_dsc(weights, gam));
    return rcpp_result_gen;
END_RCPP
}
// active_models_dsc
...
// agg_density_dsc
List agg_density_dsc(NumericVector active_weights, NumericVector oos_equity_premium, NumericMatrix oos_forecast_tvp, NumericMatrix oos_variance_tvp, IntegerVector idx_sub, int t);
RcppExport SEXP _hdflex_agg_density_dsc(SEXP active_weightsSEXP, SEXP oos_equity_premiumSEXP, SEXP oos_forecast_tvpSEXP, SEXP oos_variance_tvpSEXP, SEXP idx_subSEXP, SEXP tSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type t(tSEXP);
    rcpp_result_gen = Rcpp::wrap(agg_density_dsc(active_weights, oos_equity_premium, oos_forecast_tvp, oos_variance_tvp, idx_sub, t));
    return rcpp_result_gen;
END_RCPP
}
// update_dsc
NumericVector update_dsc(NumericVector weights, NumericVector oos_equity_premium, NumericMatrix oos_forecast_tvp, NumericMatrix oos_variance_tvp, int n_models, int t);
RcppExport SEXP _hdflex_update_dsc(SEXP weightsSEXP, SEXP oos_equity_premiumSEXP, SEXP oos_forecast_tvpSEXP, SEXP oos_variance_tvpSEXP, SEXP n_modelsSEXP, SEXP tSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type t(tSEXP);
    rcpp_result_gen = Rcpp::wrap(update_dsc(weights, oos_equity_premium, oos_forecast_tvp, oos_variance_tvp, n_models, t));
    return rcpp_result_gen;
END_RCPP
}
// dsc_loop
...
// init_tvc_forecast
List init_tvc_forecast(arma::vec& y_var, int sample_length);
RcppExport SEXP _hdflex_init_tvc_forecast(SEXP y_varSEXP, SEXP sample_lengthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type y_var(y_varSEXP);
    Rcpp::traits::input_parameter< int >::type sample_length(sample_lengthSEXP);
    rcpp_result_gen = Rcpp::wrap(init_tvc_forecast(y_var, sample_length));
    return rcpp_result_gen;
END_RCPP
}
// tvc_model
...
// tvc_model_forecasts
List tvc_model_forecasts(arma::vec& y_var, arma::vec& x_var, int i, double kappa, arma::mat theta, arma::mat cov_mat, double h);
RcppExport SEXP _hdflex_tvc_model_forecasts(SEXP y_varSEXP, SEXP x_varSEXP, SEXP iSEXP, SEXP kappaSEXP, SEXP thetaSEXP, SEXP cov_matSEXP, SEXP hSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type y_var(y_varSEXP);
    ...
    Rcpp::traits::input_parameter< arma::mat >::type cov_mat(cov_matSEXP);
    Rcpp::traits::input_parameter< double >::type h(hSEXP);
    rcpp_result_gen = Rcpp::wrap(tvc_model_forecasts(y_var, x_var, i, kappa, theta, cov_mat, h));
    return rcpp_result_gen;
END_RCPP
}
// tvc_model_loop
...
// tvc_model_loop_forecasts
List tvc_model_loop_forecasts(arma::vec& y_var, arma::vec& x_var, double kappa, arma::mat theta, arma::mat cov_mat, double h, int ts_length, int drop_length, int max_length);
RcppExport SEXP _hdflex_tvc_model_loop_forecasts(SEXP y_varSEXP, SEXP x_varSEXP, SEXP kappaSEXP, SEXP thetaSEXP, SEXP cov_matSEXP, SEXP hSEXP, SEXP ts_lengthSEXP, SEXP drop_lengthSEXP, SEXP max_lengthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type y_var(y_varSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type drop_length(drop_lengthSEXP);
    Rcpp::traits::input_parameter< int >::type max_length(max_lengthSEXP);
    rcpp_result_gen = Rcpp::wrap(tvc_model_loop_forecasts(y_var, x_var, kappa, theta, cov_mat, h, ts_length, drop_length, max_length));
    return rcpp_result_gen;
END_RCPP
}
