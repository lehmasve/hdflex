...
#'       \item{Point_Forecasts}{A vector with the first moments of the aggregate predictive densities of the DSC model.}
#'       \item{Variance_Prediction}{A vector with the second moments of the aggregate predictive densities of the DSC model.}
#'     }
#'   }
...
#'       \item{CFM}{A matrix containing the selected candidate forecasting models.}
#'     }
#'   }
